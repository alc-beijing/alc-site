...
另外，根据我们团队多年的经验来讲，能够做大upstream first才是成本最低的方式。什么叫upstream first呢，就是我们在对开源软件进行修改的时候，优先把这些改动贡献到上游项目中，而不是只在自己fork的版本中进行修改。这样我们内部开发和开源社区的开发就可以形成合力，不需要在每个版本进行适配，从长期来看才是成本最低的方式。
所以不管是对个人还是对团队，能够参与到开源社区，都是非常有价值的。
